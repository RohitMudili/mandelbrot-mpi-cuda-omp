...
### 5.2 Load-imbalance study, deep view (1920×1080, maxIter=2000, 4 ranks)
...
### 5.3 Hybrid MPI + CUDA, shallow view (1920×1080, 2 ranks)
...
- [x] Strong-scaling sweep (1, 2, 4, 8 ranks) measured and tabulated.
- [x] Load-imbalance comparison (contiguous vs cyclic) measured — 1.35× → 1.02× imbalance, 14% wall-time win.
